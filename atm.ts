...
if(pin === user.pin){console.log( chalk.greenBright( "Welcome" ));
    ...
    if(correctPin.operation === "Account information") {
        ...
        console.log(
            chalk.greenBright(`cash deposit, your balance is ${currentBalance}`)
        );
    }else if(correctPin.operation === "Balance" ) {
        console.log(
            chalk.magentaBright(`your current balance is ${currentBalance}`)
        )
        ...
        if(Withdraw <= currentBalance){
           ...
           console.log(
            chalk.yellowBright(`your remaining balance is ${remainingBalance}`)
           );
        ...
        console.log(
            chalk.grey(`your withdraw as fast cash is successfully ${fastCash.cash}`)
            );
            console.log(
                chalk.yellowBright(`Now, your balance is ${currentBalance}`)
            );
    }
}
else{
        console.log(
            chalk.redBright(" Pin is Incorrect")
        );
        console.log(
            chalk.bgRedBright("please enter your correct 4-Digit pin code")
        );
    }
